...
scaler.fit(X_train)
joblib.dump(perceptron_model, 'ambientmodel/aperceptron_model.pkl')
joblib.dump(scaler, 'ambientmodel/ascaler.pkl')
...
joblib.dump(clf, 'ambientmodel/amodelo_naive_bayes.pkl')
joblib.dump(vectorizer, 'ambientmodel/avectorizer.pkl')
joblib.dump(mlb, 'ambientmodel/amlb.pkl')
